...
console.log(Analytics);
  ...
  return (
    <>
      <div className="flex mt-24 flex-row w-full items-center space-x-5 justify-center">
        {/* Left Section */}
        <div className="space-y-5 ">
          <div className="border border-gray-200 dark:border-[#28282a] p-6 flex flex-col space-y-6 rounded-lg">
        ...
        <div className="flex flex-col space-y-5 min-w-80">
          ...
          <div className="border border-gray-200 dark:border-[#28282a] rounded-lg p-6 space-y-6 w-full md:max-w-96">
