...
function IncidentManage() {
    ...
    const handleCloseCase = (caseId) => {
        setCaseToClose(caseId);
        setShowConfirmation(true);
    };
    // Function to cancel case closure
        ...
        <>
                                                    ...
                                                    <div className="flex flex-col space-y-8">
                                                        <div className="flex space-x-5">
                                                            ...
                                                            <div
                                                                onClick={(e) => {
                                                                    e.stopPropagation();
                                                                    handleCloseCase(item._id);
                                                                }}
                                                                className="flex hover:cursor-pointer flex-col p-4 min-w-40 bg-white dark:bg-[#28282a] rounded-lg shadow-sm">
            ...
            {showConfirmation && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white dark:bg-[#28282a] p-6 rounded-lg shadow-lg max-w-md w-full">
                        <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Confirm Case Closure</h3>
                        <p className="text-gray-700 dark:text-gray-300 mb-6">Are you sure you want to close this case? This action cannot be undone.</p>
