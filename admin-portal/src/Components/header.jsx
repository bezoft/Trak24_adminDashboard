...
const Header = () => {
  ...
  return (
    <>
      ...
      {/* Side Drawer */}
      <div
        className={`fixed top-0 left-0 h-full bg-white dark:bg-[#1b1b1d] overflow-x-disabled overflow-auto shadow-lg z-40 transform transition-transform duration-300 ${isDrawerOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
        style={{ width: '300px' }}
      >
