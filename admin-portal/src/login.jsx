    ...
    return (
        <>
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative rounded-md shadow-sm">
                                <input
                                    ...
                                    className="block w-full px-4 py-3 rounded-xl border-gray-300 bg-transparent border focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 ease-in-out shadow-sm"
            ...
            <div className='hidden dark:block'>
                ...
                >
                    <div className="w-full max-w-md p-10 space-y-8 backdrop-blur-sm bg-[#1b1b1d]/20 rounded-2xl shadow-xl">
                        <div className="text-center">
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="mt-1 relative rounded-md shadow-sm">
                                    <input
                                        ...
                                        onChange={(e) => setUsername(e.target.value)}
                                        onKeyPress={handleKeyPress}
                                        className="block w-full px-4 py-3 rounded-xl border-gray-600 bg-transparent border text-white focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 ease-in-out"
                                        placeholder="Enter your username"
                                        required
                                    />
                                </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="text-sm">
                                    <a className="font-medium text-orange-400 hover:text-orange-300">
                                        Forgot password?
                                    </a>
                                </div>
                            </div>
