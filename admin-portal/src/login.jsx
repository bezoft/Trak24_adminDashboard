...
function Login() {
    ...
    return (
        <>
            ...
            >
                <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-2xl shadow-xl backdrop-blur-sm bg-opacity-90">
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative rounded-md shadow-sm">
                                <input
                                    ...
                                    className="block w-full px-4 py-3 rounded-xl border-gray-300 bg-white/50 border  transition-all duration-200 ease-in-out shadow-sm"
